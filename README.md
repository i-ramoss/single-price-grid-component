...
This project is a single price grid component
...
- Solution URL: https://www.frontendmentor.io/solutions/single-price-grid-component-JVi8FsNCIo
- Live Site URL: https://i-ramoss.github.io/single-price-grid-component/
...
This project in under MIT license, for more details check in [LICENSE](https://github.com/i-ramoss/single-price-grid-component/blob/main/LICENSE). <br>
